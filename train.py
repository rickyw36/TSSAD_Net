...
def main(args):
    ...
    cv_dataset = ArrayDataset(args.valid_dir, batch_size=1,  # 1 -> use less GPU memory to do cv
    ...
    model = FaSNet_base(enc_dim=256, feature_dim=64, hidden_dim=128, layer=6, segment_size=250, nspk = 3, win_len = 2)
